(() => {
    ...
    function addTouchClass() {
        ...
        menuArrows.forEach((arrow => {
            arrow.addEventListener("click", (e => {
                e.target;
                document.querySelectorAll(".menu__item.active").forEach((function(activeList) {
                    if (activeList !== arrow.parentElement) activeList.classList.remove("active");
                }));
                if (menuArrows = "click") arrow.parentElement.classList.toggle("active");
            }));
        }));
    }
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (bodyLockStatus && e.target.closest(".menu__sublink")) {
                bodyUnlock();
                document.documentElement.classList.remove("menu-open");
            }
            if (bodyLockStatus && e.target.closest(".social-header__link-icon")) {
                bodyUnlock();
                document.documentElement.classList.remove("menu-open");
            }
        }));
